...
is divided into following int initialization;
        int compilation;
sections:
  - initialization
  - compilation
  ...
  - cleanup
        -->
<project xmlns:if="ant:if" xmlns:j2seproject1="http://www.netbeans.org/ns/j2se-project/1" xmlns:j2seproject3="http://www.netbeans.org/ns/j2se-project/3" xmlns:jaxrpc="http://www.netbeans.org/ns/j2se-project/jax-rpc" xmlns:unless="ant:unless" basedir=".." default="default" name="Proyecto3.1_ZMKJ-impl">
    ...
    <target if="${testng.available}" name="-init-macrodef-testng">
        <macrodef name="testng" uri="http://www.netbeans.org/ns/j2se-project/3">
            ...
            <sequential>
                ...
                <testng classfilesetref="test.set" failureProperty="tests.failed" listeners="org.testng.reporters.VerboseReporter" methods="${testng.methods.arg}" mode="${testng.mode}" outputdir="${build.test.results.dir}" suitename="Proyecto3.1_ZMKJ" testname="TestNG tests" workingDir="${work.dir}">
    ...
    <target if="${testng.available}" name="-init-macrodef-testng-debug">
        <macrodef name="testng-debug" uri="http://www.netbeans.org/ns/j2se-project/3">
            ...
            <sequential>
                ...
                <condition else="-suitename Proyecto3.1_ZMKJ -testname @{testClass} ${test.class.or.method}" property="testng.cmd.args" value="@{testClass}">
    ...
    <target if="already.built.jar.${basedir}" name="-warn-already-built-jar">
        <echo level="warn" message="Cycle detected: Proyecto3.1_ZMKJ was already built"/>
    </target>
...
</project>        // TODO add your handling code here:
